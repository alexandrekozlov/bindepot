defmodule Bindepot.PyPI.API do
  ...
  def list_packages(repo_id, opts \\ %{}) do
    ...
    Repo.all(
      from p in Package,
        ...
        limit: ^limit,
        order_by: [asc: p.normalized_name]
    )
  end
  ...
  defp write_source_to_tmp_streaming(%Plug.Upload{path: path}, tmp_file),
    do: write_source_to_tmp_streaming(path, tmp_file)
